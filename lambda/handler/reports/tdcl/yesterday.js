...
const TDCL_YESTERDAY = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'TDCL_YESTERDAY'
            || (Alexa.getRequestType(handlerInput.requestEnvelope) === 'Alexa.Presentation.APL.UserEvent' &&
                handlerInput.requestEnvelope.request.arguments[0] === 'TDCL_YESTERDAY');
    },
                ...
                const datasources = {
                    "card": {
                        ...
                        "properties": {
                            ...
                            "reportTitle": "TDCL Yesterday Sales Analysis",
